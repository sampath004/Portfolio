    ...
    <?php include('header.php'); ?>
                        ...
                        <div class="sroll-nav-wrap">
                            <div class="sroll-nav-container">
                                <nav class="scroll-nav scroll-init fl-wrap">
                                    <ul>
                                        <li><a class="scroll-link act-scrlink" href="services.html#serv1">01.<span>Hero</span></a></li>
                                        <li><a class="scroll-link" href="services.html#serv2">02.<span>Architecture</span></a></li>
                                        <li><a class="scroll-link" href="services.html#serv3">03.<span>Design</span></a></li>
                                        <li><a class="scroll-link" href="services.html#serv4">04.<span>Construction</span></a></li>
                                    </ul>
                                </nav>
                            </div>
                        </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <div class="footer-box fl-wrap">
                                        <ul>
                                            <li><span>Mail :</span><a href="services.html#" target="_blank">yourmail@domain.com</a></li>
                                            <li> <span>Adress :</span><a href="services.html#" target="_blank">USA 27TH Brooklyn NY</a></li>
                                            <li><span>Phone :</span><a href="services.html#">+7(111)123456789</a></li>
                                        </ul>
                                    </div>
                                </div>
                                <div class="col-md-5">
            ...
            <footer class="main-footer">
                ...
                <div class="footer-social">
                    <ul>
                        <li><a href="services.html#" target="_blank"><i class="fa fa-facebook"></i></a></li>
                        <li><a href="services.html#" target="_blank"><i class="fa fa-twitter"></i></a></li>
                        <li><a href="services.html#" target="_blank" ><i class="fa fa-instagram"></i></a></li>
                        <li><a href="services.html#" target="_blank" ><i class="fa fa-pinterest"></i></a></li>
                        <li><a href="services.html#" target="_blank" ><i class="fa fa-tumblr"></i></a></li>
                    </ul>
                </div>
            </footer>
            <!-- footer end-->
