        ...
        <div id="main">
                    ...
                    <div class="content full-height">
                        <div class="error-wrap">
                            <div class="container">
                                ...
                                <a href="index.html" class="btn float-btn flat-btn">Back to home</a>     
                            </div>
                        </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <div class="footer-box fl-wrap">
                                        <ul>
                                            <li><span>Mail :</span><a href="404.html#" target="_blank">yourmail@domain.com</a></li>
                                            <li> <span>Adress :</span><a href="404.html#" target="_blank">USA 27TH Brooklyn NY</a></li>
                                            <li><span>Phone :</span><a href="404.html#">+7(111)123456789</a></li>
                                        </ul>
                                    </div>
                                </div>
                                <div class="col-md-5">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-9">
                                    <div class="fl-wrap policy-box">
                                        <p> &#169; Balka   2017.  All rights reserved.  </p>
                                    </div>
                                </div>
                            </div>
            ...
            <footer class="main-footer">
                ...
                <div class="footer-social">
                    <ul>
                        <li><a href="404.html#" target="_blank"><i class="fa fa-facebook"></i></a></li>
                        <li><a href="404.html#" target="_blank"><i class="fa fa-twitter"></i></a></li>
                        <li><a href="404.html#" target="_blank" ><i class="fa fa-instagram"></i></a></li>
                        <li><a href="404.html#" target="_blank" ><i class="fa fa-pinterest"></i></a></li>
                        <li><a href="404.html#" target="_blank" ><i class="fa fa-tumblr"></i></a></li>
                    </ul>
                </div>
            </footer>
            <!-- footer end-->
