                        ...
                        <div class="sroll-nav-wrap">
                            <div class="sroll-nav-container">
                                <nav class="scroll-nav scroll-init fl-wrap">
                                    <ul>
                                        <li><a class="scroll-link act-scrlink" href="about-personal.html#sec1">01.<span>Hero</span></a></li>
                                        <li><a class="scroll-link" href="about-personal.html#sec2">02.<span>About</span></a></li>
                                        <li><a class="scroll-link" href="about-personal.html#sec3">03.<span>Facts</span></a></li>
                                        <li><a class="scroll-link" href="about-personal.html#sec4">04.<span>Skills</span></a></li>
                                        <li><a class="scroll-link" href="about-personal.html#sec5">05.<span>Clients</span></a></li>
                                        <li><a class="scroll-link" href="about-personal.html#sec6">06.<span>Resume</span></a></li>
                                    </ul>
                                </nav>
                            </div>
                        </div>
                                            ...
                                            <li>
                                                <div class="team-box">
                                                    <div class="team-photo">
                                                        ...
                                                        <ul class="team-social" style="display: block;">
                                                            <li><a href="#" target="_blank" style="opacity: 0; top: 50px;"><i class="fa fa-facebook"></i></a></li>
                                                            <li><a href="#" target="_blank" style="opacity: 0; top: 50px;"><i class="fa fa-twitter"></i></a></li>
                                                            <li><a href="#" target="_blank" style="opacity: 0; top: 50px;"><i class="fa fa-tumblr"></i></a></li>
                                                            <li><a href="#" target="_blank" style="opacity: 0; top: 50px;"><i class="fa fa-behance"></i></a></li>
                                                        </ul>
                                                        <img src="images/team/1.jpg" alt="" class="respimg"><span>Find on</span>										
                                                    </div>
                                                    <div class="team-info">
                                                        <h3>David Gray</h3>
                                            ...
                                            <li>
                                                <div class="team-box">
                                                    <div class="team-photo">
                                                        ...
                                                        <img src="images/team/2.jpg" alt="" class="respimg"><span>Find on</span>										
                                                    </div>
                                                    <div class="team-info">
                                                        <h3>Austin Evon</h3>
                                                        <h4>Co-manager associated</h4>
                                            ...
                                            <li>
                                                <div class="team-box">
                                                    <div class="team-photo">
                                                        ...
                                                        <img src="images/team/3.jpg" alt="" class="respimg"><span>Find on</span>										
                                                    </div>
                                                    <div class="team-info">
                                            ...
                                            <li>
                                                <div class="team-box">
                                                    <div class="team-photo">
                                                        ...
                                                        <img src="images/team/4.jpg" alt="" class="respimg"><span>Find on</span>										
                                                    </div>
                                                    <div class="team-info">
                                                        <h3>David Gray</h3>
                                                        <h4>Co-manager associated</h4>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <div class="footer-box fl-wrap">
                                        <ul>
                                            <li><span>Mail :</span><a href="about-personal.html#" target="_blank">yourmail@domain.com</a></li>
                                            <li> <span>Adress :</span><a href="about-personal.html#" target="_blank">USA 27TH Brooklyn NY</a></li>
                                            <li><span>Phone :</span><a href="about-personal.html#">+7(111)123456789</a></li>
                                        </ul>
                                    </div>
                                </div>
                                <div class="col-md-5">
