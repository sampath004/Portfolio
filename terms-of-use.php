        ...
        <div id="main">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <div class="footer-box fl-wrap">
                                        <ul>
                                            <li><span>Mail :</span><a href="cart.html#" target="_blank">yourmail@domain.com</a></li>
                                            <li> <span>Adress :</span><a href="cart.html#" target="_blank">USA 27TH Brooklyn NY</a></li>
                                            <li><span>Phone :</span><a href="cart.html#">+7(111)123456789</a></li>
                                        </ul>
                                    </div>
                                </div>
                                <div class="col-md-5">
            ...
            <footer class="main-footer">
                ...
                <div class="footer-social">
                    <ul>
                        <li><a href="cart.html#" target="_blank" ><i class="fa fa-facebook"></i></a></li>
                        <li><a href="cart.html#" target="_blank"><i class="fa fa-twitter"></i></a></li>
                        <li><a href="cart.html#" target="_blank" ><i class="fa fa-instagram"></i></a></li>
                        <li><a href="cart.html#" target="_blank" ><i class="fa fa-pinterest"></i></a></li>
                        <li><a href="cart.html#" target="_blank" ><i class="fa fa-tumblr"></i></a></li>
                    </ul>
                </div>
            </footer>
            <!-- footer end-->
