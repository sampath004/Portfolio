                        ...
                        <section class="parallax-section header-section" data-scrollax-parent="true">
                            ...
                            <div class="container big-container">
                                <div class="section-title">
                                    ...
                                    <a href="contact.html#sec1" class="custom-scroll-link sect-scroll-link"><i class="fa fa-long-arrow-down"></i> <span>scroll down</span></a>
                                </div>
                            </div>
                        </section>
                        <!--  section  end-->
                                            ...
                                            <div class="contact-details fl-wrap">
                                                <div class="row border-dec">
                                                    <div class="col-md-6">
                                                        ...
                                                        <ul>
                                                            <li><span>Mail :</span><a href="contact.html#" target="_blank">yourmail@domain.com</a></li>
                                                            <li><span>Adress :</span><a href="contact.html#" target="_blank">USA 27TH Brooklyn NY</a></li>
                                                            <li><span>Phone :</span><a href="contact.html#">+7(111)123456789</a></li>
                                                        </ul>
                                                    </div>
                                                    <div class="col-md-6">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-9">
                                            ...
                                            <div class="contact-form-holder fl-wrap">
                                                <div id="contact-form">
                                                    <div id="message"></div>
                                                    <form method="post" action="http://balkon.kwst.net/site/light/php/contact.php" name="contactform" id="contactform">
