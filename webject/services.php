...
<head>
    <!--=============== basic  ===============-->
    <meta charset="UTF-8">
    <title>Webject Systems Inc - Services</title>
    <meta name="viewport"
        ...
        <div class="content-holder">
            ...
            <div class="content">
                ...
                <section class="parallax-section header-section" data-scrollax-parent="true" id="serv1">
                    <div class="bg" data-bg="images/web/services2.jpg"
                    ...
                    <div class="container big-container">
                        <div class="section-title">
                            ...
                            <p>Curabitur bibendum mi sed rhoncus aliquet. Nulla blandit porttitor justo, at posuere sem
                                accumsan nec.</p>
                            <a href="services.php#serv2" class="custom-scroll-link sect-scroll-link"><i
                    ...
                    <div class="container">
                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        <div class="pr-title dektop-only-center">
                                            ...
                                            <span>Lorem Ipsum generators on the Internet tend to repeat king this the
                                                first true generator . </span>
                                        </div>
                                    </div>
                                    <div class="col-md-8">
                                        <div class="content-wrap about-wrap">
                                            <div class="blog-media fl-wrap">
                                                <div class="box-item">
                                                    <img src="images/web/software_dev.jpeg" class="respimg" alt="">
                                                </div>
                                            </div>
                                    ...
                                    <div class="col-md-12">
                                        <h3 class="bold-title">There are many variations of passages of Lorem Ipsum
                                            available</h3>
                                        <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Cras lacinia magna
                                            vel molestie faucibus. Donec auctor et urnaLorem ipsum dolor sit amet,
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-8">
                                        <div class="content-wrap about-wrap">
                                            <div class="blog-media fl-wrap">
                                                <div class="box-item">
                                                    <img src="images/web/consulting.jpeg" class="respimg" alt="">
                                                </div>
                                            </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-8">
                                        <div class="content-wrap about-wrap">
                                            <div class="blog-media fl-wrap">
                                                <div class="box-item">
                                                    <img src="images/web/engineering.jpeg" class="respimg" alt="">
                                                </div>
                                            </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-8">
                                        <div class="content-wrap about-wrap">
                                            <div class="blog-media fl-wrap">
                                                <div class="box-item">
                                                    <img src="images/web/web_dev.jpg" class="respimg" alt="">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-8">
                                        <div class="content-wrap about-wrap">
                                            <div class="blog-media fl-wrap">
                                                <div class="box-item">
                                                    <img src="images/web/data_warehousing.jpeg" class="respimg" alt="">
                                                </div>
                                            </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-8">
                                        <div class="content-wrap about-wrap">
                                            <div class="blog-media fl-wrap">
                                                <div class="box-item">
                                                    <img src="images/web/it_support.jpeg" class="respimg" alt="">
                                                </div>
                                            </div>
                        ...
                        <div class="order-item fl-wrap">
                            <div class="row">
                                ...
                                <div class="col-md-3"><a href="contact.php" class="btn float-btn flat-btn">Get in
                                        Touch</a></div>
                            </div>
                        </div>
                    </div>
