                ...
                <div class="content-holder">
                    ...
                    <div class="content ">
                        ...
                        <section class="parallax-section header-section" data-scrollax-parent="true" id="serv1">
                            <div class="bg"  data-bg="images/web/industries.jpg" data-scrollax="properties: { translateY: '200px' }"></div>
                            ...
                            <div class="container big-container">
                                <div class="section-title">
                                    ...
                                    <a href="services.html#serv2" class="custom-scroll-link sect-scroll-link"><i class="fa fa-long-arrow-down"></i> <span>scroll down</span></a>
                                </div>
                            </div>
                        </section>
                        <!--  section  end--> 
                                            ...
                                            <div class="blog-media fl-wrap">
                                                <div class="single-slider fl-wrap" data-effects="slide">
                                                    <div class="swiper-container swiper-container-horizontal swiper-container-autoheight" style="cursor: grab;">
                                                        <div class="swiper-wrapper" style="height: 510px; transform: translate3d(-770px, 0px, 0px); transition-duration: 0ms;"><div class="swiper-slide swiper-slide-duplicate swiper-slide-prev" data-swiper-slide-index="2" style="width: 770px;"><img src="images/folio/20.jpg" alt=""></div>
                                                            <div class="swiper-slide swiper-slide-active" data-swiper-slide-index="0" style="width: 770px;"><img src="images/folio/10.jpg" alt=""></div>
                                                            <div class="swiper-slide swiper-slide-next" data-swiper-slide-index="1" style="width: 770px;"><img src="images/folio/19.jpg" alt=""></div>
                                                            <div class="swiper-slide swiper-slide-duplicate-prev" data-swiper-slide-index="2" style="width: 770px;"><img src="images/folio/20.jpg" alt=""></div>
                                                        <div class="swiper-slide swiper-slide-duplicate swiper-slide-duplicate-active" data-swiper-slide-index="0" style="width: 770px;"><img src="images/folio/10.jpg" alt=""></div></div>
                                ...
                                <div class="gallery-item   interior">
                                    <div class="grid-item-holder">
                                        <div class="box-item">
                                            ...
                                            <div class="overlay"></div>
                                            <a href="images/folio/3.jpg" class="image-popup popup-image"><i class="fa fa-search"  ></i></a>
                                        </div>
                                        <div class="grid-item">
                                            <h3><a href="portfolio-single.html">Theatre Agora</a></h3>
                                ...
                                <div class="gallery-item houses">
                                    <div class="grid-item-holder">
                                        <div class="box-item">
                                            ...
                                            <div class="overlay"></div>
                                            <a href="images/folio/6.jpg" class="image-popup popup-image"><i class="fa fa-search"  ></i></a>
                                        </div>
                                        <div class="grid-item">
                                            <h3><a href="portfolio-single.html">Beach and Howe</a></h3>
                                            <span>Hoses Design</span>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <div class="footer-box fl-wrap">
                                        <ul>
                                            <li><span>Mail :</span><a href="portfolio3.html#" target="_blank">yourmail@domain.com</a></li>
                                            <li> <span>Adress :</span><a href="portfolio3.html#" target="_blank">USA 27TH Brooklyn NY</a></li>
                                            <li><span>Phone :</span><a href="portfolio3.html#">+7(111)123456789</a></li>
                                        </ul>
                                    </div>
                                </div>
                                <div class="col-md-5">
