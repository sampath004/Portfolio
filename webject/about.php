                ...
                <div class="content-holder">
                    ...
                    <div class="content">
                        ...
                        <div class="sroll-nav-wrap">
                            <div class="sroll-nav-container">
                                <nav class="scroll-nav scroll-init fl-wrap">
                                    <ul>
                                        <li><a class="scroll-link act-scrlink" href="about.html#sec1">01.<span>Hero</span></a></li>
                                        <li><a class="scroll-link" href="about.html#sec2">02.<span>About</span></a></li>
                                        <li><a class="scroll-link" href="about.html#sec3">03.<span>Skills</span></a></li>
                                        <li><a class="scroll-link" href="about.html#sec4">04.<span>Video</span></a></li>
                                        <li><a class="scroll-link" href="about.html#sec5">05.<span>Team</span></a></li>
                                        <li><a class="scroll-link" href="about.html#sec6">06.<span>Story</span></a></li>
                                    </ul>
                                </nav>
                            </div>
                        </div>
                        ...
                        <section class="parallax-section header-section" data-scrollax-parent="true" id="sec1">
                            <div class="bg"  data-bg="images/web/home_team.png" data-scrollax="properties: { translateY: '200px' }"></div>
                            ...
                            <div class="container big-container">
                                <div class="section-title">
                                    ...
                                    <a href="about.html#sec2" class="custom-scroll-link sect-scroll-link"><i class="fa fa-long-arrow-down"></i> <span>scroll down</span></a>
                                </div>
                            </div>
                        </section>
                        <!--  section end --> 
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-8">
                                            <div class="content-wrap about-wrap">
                                                ...
                                                <h3 class="bold-title">Welcome!  We  are Balkon</h3>
                        ...
                        <section  class=" parallax-section content-parallax-section" data-scrollax-parent="true">
                            <div class="bg"  data-bg="images/web/get_in_touch1.jpg" data-scrollax="properties: { translateY: '200px' }"></div>
                            <div class="overlay"></div>
                            <div class="container">
                                <div class="intro-text fl-wrap">
                                    <h2>Ready to order your project ?  <br>Get in touch</h2>
                                    <a href="contact.html" class="btn float-btn flat-btn">Our Contacts</a>
                                </div>
                            </div>
                        </section>
                        <!--  section end --> 
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <div class="footer-box fl-wrap">
                                        <ul>
                                            <li><span>Mail :</span><a href="about.html#" target="_blank">yourmail@domain.com</a></li>
                                            <li> <span>Adress :</span><a href="about.html#" target="_blank">USA 27TH Brooklyn NY</a></li>
                                            <li><span>Phone :</span><a href="about.html#">+7(111)123456789</a></li>
                                        </ul>
                                    </div>
                                </div>
                                <div class="col-md-5">
            ...
            <footer class="main-footer">
                ...
                <div class="footer-social">
                    <ul>
                        ...
                        <li><a href="about.html#" target="_blank" ><i class="fa fa-tumblr"></i></a></li>
                    </ul>
                </div>
            </footer>
            <!-- footer end-->
