                        ...
                        <div class="swiper-container" data-scrollax-parent="true" >
                            <div class="swiper-wrapper"  >
                                ...
                                <div class="swiper-slide">
                                    <div class="bg"  data-bg="images/web/banner1.jpg" data-scrollax="properties: { translateY: '250px' }" ></div>
                                    <!-- hero-wrap-->           
                                ...
                                <!-- swiper-slide-->
                                <div class="swiper-slide">
                                    <div class="bg"  data-bg="images/web/banner2.jpg" data-scrollax="properties: { translateY: '250px' }" ></div>
                                    <!-- hero-wrap-->           
                                    <div class="hero-wrap alt">
                                        <div class="container">
                                            <div class="hero-item">
                                ...
                                <!-- swiper-slide-->
                                <div class="swiper-slide">
                                    <div class="bg"  data-bg="images/web/banner5.jpg" data-scrollax="properties: { translateY: '250px' }" ></div>
